    ...
    public class Helper
    {
        ...
        public static Image GetImageFromClipboard()
        {
            ...
            if (clipboard != null)
            {
                ...
                //if (clipboard.GetFormats().Contains("Format17"))
                //{
                //    byte[] datab;
                //    using (MemoryStream ms = (MemoryStream)clipboard.GetData("Format17"))
                //    {
                //        datab = ms.ToArray();
                //    }
                //    return Helper.CF_DIBV5ToBitmap(datab);
                //}
                //else
                //{
        ...
        internal static DialogResult ScriptEditor(ScriptDetails script1, ScriptDetails script2, List<Tuple<string, string>> variables)
        {
