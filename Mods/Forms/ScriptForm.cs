...
namespace BeatificaBytes.Synology.Mods
{
    ...
    public partial class ScriptForm : Form
    {
        ...
        private HelpInfo helpVarDefault = new HelpInfo(new Uri("https://help.synology.com/developer-guide/synology_package/script_env_var.html"), "Details about environment variables");
        ...
        private void ScriptForm_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                VarInfo.GetSynoEnvVariables(variables);
